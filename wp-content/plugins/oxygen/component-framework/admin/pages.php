...
function ct_cache_page_callback() {
	...
	<div class="oxygen-vsb-settings-container">
		...
		<p><?php _e("<strong>WARNING!</strong> - These settings should not be modified unless you're advise to do so by Oxygen support staff, or you fully understand the risks associated with doing so."); ?></p>
